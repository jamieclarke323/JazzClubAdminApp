...
urlpatterns = [
    ...
    path('important-info/', views.important_info_view, name='important_info'),
    path('important-info/create/', views.important_info_create, name='important_info_create'),
    path('important-info/<int:info_id>/delete/', views.important_info_delete, name='important_info_delete'),
    path('important-info/<int:info_id>/move/', views.important_info_move, name='important_info_move'),
